...
%endif
  ...
  --with-compiledby="<wangjiezhe@gmail.com>" \
  --with-modified-by="<wangjiezhe@gmail.com>"
...
%configure --with-features=huge \
  ...
  --with-compiledby="<wangjiezhe@gmail.com>" --enable-cscope \
  --with-modified-by="<wangjiezhe@gmail.com>" \
%if "%{withnetbeans}" == "1"
  --enable-netbeans \
%else
...
%configure --prefix=%{_prefix} --with-features=huge \
 ...
 --enable-cscope --with-modified-by="<wangjiezhe@gmail.com>" \
 --with-tlib=ncurses \
 --with-compiledby="<wangjiezhe@gmail.com>" \
%if "%{withnetbeans}" == "1"
  --enable-netbeans \
...
%changelog
* Sat Jul 04 2015 Jiezhe Wang <wangjiezhe@gmail.com> 7.4.764-1
- patchlevel 764

* Sat May 23 2015 Jiezhe Wang <wangjiezhe@gmail.com> 7.4.729-3
- use --with-pythoninterp=yes, --with-rubyinterp=yes and --with-luainterp=yes

* Sat May 23 2015 Jiezhe Wang <wangjiezhe@gmail.com> 7.4.729-2
- enable lua support

* Sat May 23 2015 Jiezhe Wang <wangjiezhe@gmail.com> 7.4.729-1
- patchlevel 729
